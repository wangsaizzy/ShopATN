...
@implementation LoginSecretCodeView
...
- (UITextField *)phoneNumberTF {
    if (!_phoneNumberTF) {
        self.phoneNumberTF = [[UITextField alloc] initWithFrame:CGRectMake(95 * kMulriple, 15 * kHMulriple, 125 * kMulriple, 35 * kHMulriple)];
        self.phoneNumberTF.placeholder = @"请输入手机号";
        _phoneNumberTF.font = KFont;
...
- (UITextField *)reSetSecretNumberTF {
    if (!_reSetSecretNumberTF) {
        ...
        _reSetSecretNumberTF.font = KFont;
